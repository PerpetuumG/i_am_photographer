...
$subject ="Новая заявка с сайта konstantinovka.pp.ua";
...
$header .= "From: Новая заявка <alpeyev@svinets.com.ua>\n\n";
$mail = mail("alpeyev@svinets.com.ua", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
